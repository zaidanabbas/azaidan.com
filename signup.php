...
<form action="/inc/signup.inc.php" method="post">
    <label for="name">Name</label><br>
        ...
        <button type="submit" style="color:white;background-color:black;border:none;border-radius:100vw;" value="Signup">Signup</button>


      </form>
      <p>Already a member <a href="/login/login">Login</a></p>
