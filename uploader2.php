...
<html lang="en">
  ...
  <div id="ADS1">
  <form action="uploadads2.php" method="post" enctype="multipart/form-data">
  <br><br><br><br><br><br>
              <input class="button" type="file" name="my_image" value="+"><br>
              <textarea autofocus name="message"  cols="20" rows="5" placeholder="message"></textarea><br>
              <input inputmode="numeric" name="price" placeholder="Price"><br>
              <input name="name" placeholder="Name of Seller"><br>
              <input name="number_email" type="text" placeholder="Number"><br>
              <input name="email" inputmode="numeric" placeholder="Email"><br>
