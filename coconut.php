...
<meta name="theme-color" content="#ffffff">
  ...
  <div id="ADS1">
    <?php 
          $sql = "SELECT * FROM coco ORDER BY id DESC";
            ...
            <div class="alb">
              ...
              <div>
                ...
                <br>
                    ...
                    <img style="border-radius:3vw;max-width: 325px;max-height: 325px;"  src="/uploads/ADS/<?=$images['image_url'];?>" alt="photo of">
